        ...
        <div className="container">
          ...
          <div className="row margin-t-50 padding-t-32">
            <div className="col-lg-3 col-sm-6">
              <div className="team-box text-center hover-effect">
                <div className="team-wrapper">
                  <div className="team-member mem1">
                   <a href="images/index1.html">
                    <img
                      alt=""
                ...
                <h4 className="team-name">Vishal Vinod</h4>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="team-box text-center hover-effect">
                <div className="team-wrapper">
                  <div className="team-member mem2">
                    <img
                      alt=""
                      src="images/team/img-3.jpg"
                      className="img-fluid rounded"
                ...
                <h4 className="team-name">Member 1</h4>
                <p className="text-uppercase team-designation">
                  Designation
                </p>
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="team-box text-center hover-effect">
                <div className="team-wrapper">
                  <div className="team-member mem3">
                    <img
                      alt=""
                      src="images/team/img-3.jpg"
                      className="img-fluid rounded"
                ...
                <h4 className="team-name">Member 2</h4>
                <p className="text-uppercase team-designation">
                  Designation
                </p>
              </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="team-box text-center hover-effect">
                <div className="team-wrapper">
                  <div className="team-member mem4">
                ...
                <h4 className="team-name">Member 3</h4>
                <p className="text-uppercase team-designation">
                  Designation
                </p>
              </div>
