                      ...
                      <div class="image-flip" >
                          <div class="mainflip flip-0">
                              <div class="frontside">
                                  <div class="card">
                                      <div class="card-body text-center">
                                          <p><img class=" img-fluid" src="images/team/avinash.jpeg" alt="card image"/></p>
                                          <h4 class="card-title">Avinash </h4>
                                          <h3 class="card-text">Assistant head of design  </h3>
                                      </div>
                                  </div>
                              </div>
                              <div class="backside">
                                  <div class="card">
                                    ...
                                    <p class="card-text">You cant use up creativity,The more you use,the more you have</p>
                                          <ul class="list-inline">
                                              ...
                                              <li class="list-inline-item">
                                                  <a class="social-icon text-xs-center" target="_blank" href="https://www.linkedin.com/in/avinash-pulugurtha-98b862160/">
                                                      <i class="fa fa-linkedin"></i>
                                                  </a>
                                              </li>
                                              <li class="list-inline-item">
                                                  <a class="social-icon text-xs-center" target="_blank" href="https://www.instagram.com/avi_411">
                                                      <i class="fa fa-instagram"></i>
                                                  </a>
                                              </li>
                                              <li class="list-inline-item">
                                  ...
                                  <div class="card">
                                      ...
                                      <p class="card-text">3rd year, Electrical and Electronics Engineering</p>
                                          <ul class="list-inline">
                                              ...
                                              <li class="list-inline-item">
                                                  <a class="social-icon text-xs-center" target="_blank" href="https://www.linkedin.com/in/rhonarula/">
                                                      <i class="fa fa-linkedin"></i>
                                                  </a>
                                              </li>
                                              <li class="list-inline-item">
                                                  <a class="social-icon text-xs-center" target="_blank" href="https://www.instagram.com/rhonarula/">
                                                      <i class="fa fa-instagram"></i>
                                                  </a>
                                              </li>
                                              <li class="list-inline-item">
